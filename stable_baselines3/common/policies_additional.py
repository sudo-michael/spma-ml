...
class ActorCriticPolicy(BasePolicy):
    ...
    def __init__(
        ...
        # TODO: parameters of the actor and critic.
        self.params_act = []
        ...
        self._build(lr_schedule_actor)
        
        # TODO: adding the environment to do value sampling if needed.
        self.env = env
    ...
    def _build(self, lr_schedule_actor: Schedule) -> None:
        """
        ...
        # TODO: seperate the parameters of the actor and critic.
        for name, param in self.named_parameters():
            if "value_net" not in name:
                self.params_act.append(param)
                self.params_act_prev.append(param)

        # TODO: build the optimizer for the actor and critic separately.
    ...
    def forward_softmax_rep(self, obs: th.Tensor, deterministic: bool = False) -> Tuple[th.Tensor, th.Tensor, th.Tensor]:
        """
    ...
    def evaluate_actions(self, obs: PyTorchObs, actions: th.Tensor, with_entropy: bool = False) -> Tuple[th.Tensor, th.Tensor, Optional[th.Tensor]]:
        """
